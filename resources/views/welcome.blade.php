...
<body class="font-sans min-h-screen relative overflow-x-hidden">
    ...
    <div class="relative z-10">
        ...
        <header class="flex justify-between items-center px-6 py-4 bg-white/60 shadow-md sticky top-0 backdrop-blur-md z-50">
            <h1 class="text-2xl font-bold text-indigo-600 text-[#8ABB6C]">LombaKita</h1>
            <nav class="space-x-4">
                <a href="{{ route('login') }}" class="text-indigo-600 hover:underline text-[#8ABB6C]">Login</a>
                <a href="{{ route('register') }}"
                   class="bg-indigo-600 text-white px-4 py-2 rounded-full hover:bg-indigo-700 transition bg-[#8ABB6C]">
                    Daftar
                </a>
            </nav>
        </header>
...
Petualangan dimulai di sini. 🍃
            ...
            <div class="flex flex-col md:flex-row justify-center items-center gap-4 mb-16">
                <a href="{{ route('login') }}"
                   class="px-6 py-3 rounded-full bg-white text-indigo-600 font-semibold shadow hover:shadow-lg transition text-[#8ABB6C]">
                    Masuk
                </a>
                <a href="{{ route('register') }}"
                   class="px-6 py-3 rounded-full bg-indigo-500 text-white font-semibold shadow hover:bg-indigo-600 transition bg-[#8ABB6C]">
                    Daftar Sekarang
                </a>
            </div>
            ...
            <section class="grid gap-6 md:grid-cols-3">
                <div class="bg-white/80 backdrop-blur p-6 rounded-2xl shadow hover:shadow-lg transition text-center text-gray-800">
                    ...
                    <h3 class="text-xl font-bold mb-2 text-[#059212]">Beragam Lomba</h3>
